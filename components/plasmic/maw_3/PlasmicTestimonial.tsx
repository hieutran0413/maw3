...
import Avatar from "../../Avatar"; // plasmic-import: TK-OHuh-kOue/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: XnlIbnMa6LB3/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: RoVqHMXV6zR1/icon
  ...
  return (
    ...
    >
      <Avatar
        ...
        pic={
          <PlasmicImg__
            ...
            displayWidth={"100%"}
            src={{
              src: "/plasmic/maw_3/images/profilepic.png",
              fullWidth: 192,
              fullHeight: 192,
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__kpw6)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__kOxtH)}
        >
          <div
            className={classNames(
              projectcss.all,
