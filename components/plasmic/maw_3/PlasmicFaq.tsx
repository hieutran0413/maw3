...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: Ph7Y-V13cVRx/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__yohsb)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__bXwn)}>
          <div className={classNames(projectcss.all, sty.freeBox__q6Wtw)}>
            {renderPlasmicSlot({
