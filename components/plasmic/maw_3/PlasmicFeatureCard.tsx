...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: 8Wq9pn2Xo-Lh/css
...
function PlasmicFeatureCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__iiZiI, {
          [sty.freeBoxlong__iiZiIq2Cl]: hasVariant($state, "long", "long")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__v7Ck8, {
            [sty.freeBoxlong__v7Ck8Q2Cl]: hasVariant($state, "long", "long")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__jzhUi)}
                role={"img"}
              />
            ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___4Kr4M, {
          [sty.freeBoxlong___4Kr4Mq2Cl]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__tWmhK, {
          [sty.freeBoxlong__tWmhKq2Cl]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__oDcVh)}
              role={"img"}
            />
          ),
