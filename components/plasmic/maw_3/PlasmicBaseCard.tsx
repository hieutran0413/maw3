...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: 1w0IG1sXar9G/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__tv08Q, {
          [sty.freeBoxlong__tv08Qyn38L]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__ea5Cj, {
          [sty.freeBoxlong__ea5Cjyn38L]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__ozkPx)}
              role={"img"}
            />
          ),
